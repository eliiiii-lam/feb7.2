    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.left_bumper) {
                slowMode = !slowMode; // Toggle the slow mode
            }

            double powerFactor = slowMode ? 0.25 : 1.0;


            double speedMultiplier = 1.0; // Default multiplier for normal speed


            if (slowMode) {
                speedMultiplier = 0.5; // Set the multiplier to half speed
            }
            ...
            double y = -gamepad1.left_stick_y * powerFactor;
